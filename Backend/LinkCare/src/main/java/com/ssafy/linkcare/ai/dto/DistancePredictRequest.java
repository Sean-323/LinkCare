...
/**
 * Distance 성장률 예측 요청 DTO
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class DistancePredictRequest {
    private int member_count;
    private double avg_age;
    private double avg_bmi;
    private double group_distance_mean_3w;
    private double group_distance_var_3w;  // 표준편차 (필드명은 var이지만 실제 값은 std)
